...
const Board = () => {
  ...
  return (
    <div className="container">
      {/* <center><button class="applybtn mb-5" onClick={form}>See Final Results</button></center> */}
      <center class=" pt-5"><h1>Overall Winners</h1></center>
      <hr></hr>
        ...
        <div class="pt-5  row justify-content-center">
          <div class="col-3 text-center pt-4">
            ...
            <div class="" style={{"font-size":"16px"}}>Samiksha</div>
            <div class="" style={{"font-size":"16px"}}>KZN350596</div>
            <div class="" style={{"font-size":"16px"}}>91425</div>
            </div>
      ...
      {/* <div className="d-flex justify-content-between mb-1">
          ...
          <center class="pt-5"><h1>Top Performers</h1></center>
          <hr></hr>
      ...
      <p className='update' style={{textAlign : "center", color:"snow", width:"94.5%"}}>Note: The information regarding the Certificate of Participation, Certificate of Appreciation, Merit Certificate, Letter of Recommendations and Gift Hampers will be communicated to the top performers.</p>

      <h1 className='text-center mt-4 pt-5' style={{fontFamily : "Meriweather"}}>LeaderBoard</h1>
      <hr/>
        <div className="d-flex justify-content-between mb-1 w-96 m-auto">
        <div className=''>
          <button className="text-dark mx-3 btns mb-3" onClick={() => setLeadersData(overallData)} style={{backgroundColor:"aquamarine"}}>Overall</button>
      ...
      <div className="d-flex justify-content-between mb-1">
          <div className="update">
           <p>Last Updated on: 13th April 2023</p> 
          </div>          
          {/* <form > */}
          <form onSubmit={handleSearch} >
            <input type="text" placeholder="Search by Referral" value={searchName} onChange={(e) => setSearchName(e.target.value)} className="form-control search  mr-1" />
