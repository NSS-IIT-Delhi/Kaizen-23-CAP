...
const Winners = () => {
  ...
  return (
    <div className="container">
      ...
      <center class=" pt-5  pb-3"><h1>Overall Winners</h1></center>
      ...
      <p style={{textAlign : "center", color:"snow", width:"94.5%"}}>Note: The information regarding the Certificate of Participation, Certificate of Appreciation, Merit Certificate, Letter of Recommendations and Gift Hampers will be communicated to the top performers.</p>
    </div>
  );
};
